...
void Fractal::Affiche_fractal(point p1, point p2, point p3, int nb_sub, reel hmin, reel hmax, const Transformation& v, const Attributs& a) const
{
	if (nb_sub == 0) {
		vecteur v1 = vecteur(p2, p1);
		vecteur v2 = vecteur(p3, p2);
		vecteur N = v1 ^ v2;
		Affiche_Trigone(p1, p2, p3, N, N, N, v, a);
	}
	else
	{
		point p12 = milieu(p1, p2, hmin, hmax);
		point p13 = milieu(p1, p3, hmin, hmax);
		point p23 = milieu(p2, p3, hmin, hmax);

		Affiche_fractal(p1, p12, p13, nb_sub - 1, hmin/2, hmax/2, v, a);
		Affiche_fractal(p12, p2, p23, nb_sub - 1, hmin/2, hmax/2, v, a);
		Affiche_fractal(p13, p23, p3, nb_sub - 1, hmin/2, hmax/2, v, a);
		Affiche_fractal(p13, p12, p23, nb_sub - 1, hmin/2, hmax/2, v, a);
	}
}
...
//  nbiter = niveau de subdivision du fractal à afficher
	...
	//Affiche_fractal(this->pt1, this->pt2, this->pt3, nbiter, this->h1, this->h2, v, a0);
	Affiche_fractal(this->pt1, this->pt2, this->pt3, nbiter, this->h1, this->h2, t, a1);
// ... 
